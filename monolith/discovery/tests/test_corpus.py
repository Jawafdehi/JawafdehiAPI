...
from monolith.discovery import corpus
from nes_service.entities.models import StoredEntity
from ngm_service.courts.models import Court, CourtCase
from ngm_service.materials.jsonld import MATERIAL_CONTEXT, MaterialType
...
class BadRowResilienceTests(TestCase):
    ...
    def test_courtcase_value_error_row_is_skipped_not_raised(self):
        ...
        with mock.patch(
            "ngm_service.materials.jsonld.court_case_material_iri", side_effect=fake
        ):
            resources = list(corpus.iter_resources((corpus.TYPE_COURTCASE,)))
