"""Test settings for the consolidated Jawafdehi platform (monolith).
...
this module. To run ``manage.py test`` on sqlite explicitly:
    ...
    DJANGO_SETTINGS_MODULE=monolith.config.settings_test python manage.py test
...
from monolith.config.settings import *  # noqa: F401,F403,E402
