...
# NES + NGM models live in sibling apps; the DB router (monolith.config.db_router)
...
# ``monolith.search``), which queries all four OpenSearch indices.
...
class FeedbackView(APIView):
    ...
    # (monolith) settings default to ReadOnlyOrAuthenticatedWrite, which would
