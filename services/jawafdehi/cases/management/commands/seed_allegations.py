...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write("Creating entity binds...")

        # Entities are owned by NES; binds store the canonical nes_id directly.
        ...
        ciaa_report.related_entities = [
            "https://jawafdehi.org/entity/person/balakrishna-khand",
            "https://jawafdehi.org/entity/organization/government_body/nepal-government",
        ]
        ciaa_report.save()
        ...
        coop_complaint.related_entities = [
            "https://jawafdehi.org/entity/person/rabi-lamichhane",
        ]
        coop_complaint.save()
        ...
        coop_testimony.related_entities = [
            "https://jawafdehi.org/entity/person/rabi-lamichhane",
        ]
        coop_testimony.save()
        ...
        audit_report.related_entities = [
            "https://jawafdehi.org/entity/organization/government_body/melamchi-water-supply-board",
        ]
        audit_report.save()
        ...
        campaign_videos.related_entities = [
            "https://jawafdehi.org/entity/person/kp-sharma-oli",
        ]
        campaign_videos.save()
        ...
        media_coverage.related_entities = [
            "https://jawafdehi.org/entity/person/sandeep-lamichhane",
        ]
        media_coverage.save()
...
<p>Multiple government officials, including former ministers and land revenue officers, are accused of facilitating the illegal transfer through document forgery and abuse of authority.</p>""",
        ...
        set_case_entities(
            ...
            alleged_ids=[
                "https://jawafdehi.org/entity/person/balakrishna-khand",
                "https://jawafdehi.org/entity/person/madhav-prasad-ghimire",
            ],
            related_ids=[
                "https://jawafdehi.org/entity/organization/government_body/nepal-government",
                "https://jawafdehi.org/entity/organization/government_body/land-revenue-office-dillibazar",
            ],
            location_ids=["https://jawafdehi.org/entity/location/district/kathmandu"],
        )
...
<p>The allegations led to his resignation as Deputy Prime Minister and Home Minister, and subsequent arrest in the cooperative fraud case.</p>""",
        ...
        set_case_entities(
            rabi,
            alleged_ids=["https://jawafdehi.org/entity/person/rabi-lamichhane"],
            related_ids=[
                "https://jawafdehi.org/entity/organization/political_party/rastriya-swatantra-party"
            ],
            location_ids=["https://jawafdehi.org/entity/location/district/chitwan"],
        )
...
<p>Citizens were promised reliable water supply for over two decades, with multiple governments failing to deliver despite massive public investment.</p>""",
        ...
        set_case_entities(
            ...
            related_ids=[
                "https://jawafdehi.org/entity/organization/government_body/ministry-of-water-supply"
            ],
            location_ids=["https://jawafdehi.org/entity/location/district/kathmandu-valley"],
        )
...
<strong>Reality</strong>: Multiple corruption scandals emerged during his tenure</p>""",
        ...
        set_case_entities(
            oli,
            alleged_ids=["https://jawafdehi.org/entity/person/kp-sharma-oli"],
            related_ids=[
                "https://jawafdehi.org/entity/organization/political_party/nepal-communist-party",
                "https://jawafdehi.org/entity/organization/government_body/nepal-government",
            ],
            location_ids=["https://jawafdehi.org/entity/location/nepal"],
        )
...
<li>Victim and accused privacy</li>
        ...
        set_case_entities(
            media,
            alleged_ids=["https://jawafdehi.org/entity/person/sandeep-lamichhane"],
            related_ids=[
                "https://jawafdehi.org/entity/organization/political_party/national-independent-party"
            ],
            location_ids=["https://jawafdehi.org/entity/location/district/kathmandu"],
        )
        ...
        self.stdout.write(
            f"  - {CaseEntityRelationship.objects.values('nes_id').distinct().count()} "
            "distinct NES entity binds"
        )
