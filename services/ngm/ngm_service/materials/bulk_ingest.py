...
The NGM counterpart to ``nes_service.services.bulk_ingest`` — the batch write
...
…) as :class:`~ngm_service.materials.models.Material` rows.
...
from nes_service.services.bulk_ingest.models import IngestSource
