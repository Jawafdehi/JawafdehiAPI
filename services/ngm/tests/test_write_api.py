...
Run under the monolith settings (DB-less: sqlite fallback, managed court tables)
from the repo root::

    DATABASE_URL=sqlite:// NES_DB_URL=sqlite:// NGM_DATABASE_URL=sqlite:// \
        uv run pytest services/ngm/tests/test_write_api.py
"""
...
from ngm_service.courts.models import BlacklistedFirm, Court, CourtCase
from ngm_service.materials.jsonld import MATERIAL_CONTEXT, court_case_material_iri
