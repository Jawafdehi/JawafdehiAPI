...
ENTITY_INDEX = "nes-entities"  # nes_service.entities -> StoredEntity
MATERIAL_INDEX = "ngm-materials"  # ngm_service.materials -> Material
COURTCASE_INDEX = "ngm-courtcases"  # ngm_service.courts -> CourtCase
