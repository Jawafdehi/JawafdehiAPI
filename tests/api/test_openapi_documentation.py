...
class TestOpenAPIDocumentation:
    ...
    def test_schema_contains_unified_search_endpoint(self):
        ...
        # plus the court-side charge/statute_section), offset paging
        # (page/page_size), the tags-facet width (tags_limit), and the deep-paging
        # cursor (search_after). ``status`` is the coarse case-lifecycle refine
        # facet.
