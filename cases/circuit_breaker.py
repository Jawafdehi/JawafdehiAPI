...
class CircuitBreaker:
    ...
    def call(self, fn, *args, **kwargs):
        ...
        with self._lock:
            ...
            is_probe = self._state == "half-open"
            if is_probe:
        ...
        try:
            ...
            self._record_success(admission_generation, is_probe)
            return result
    ...
    def _record_success(self, admission_generation: int, is_probe: bool) -> None:
        with self._lock:
            if not is_probe and admission_generation != self._generation:
                return
