...
def _parse_nepali_number(text: str) -> int | None:
    """Parse a Nepali Devanagari numeral string into an integer, or return None."""
    cleaned = "".join(CASINO_NEPALI_NUMBERS.get(ch, ch) for ch in text)
