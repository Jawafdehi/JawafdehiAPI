...
class NewsletterSubscription(models.Model):
    ...
    sendpulse_synced_at = models.DateTimeField(null=True, blank=True)
    sendpulse_sync_status = models.CharField(max_length=20, blank=True)
    sendpulse_sync_error = models.TextField(blank=True)
    sendpulse_last_attempt_at = models.DateTimeField(null=True, blank=True)
